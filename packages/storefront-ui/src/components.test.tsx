...
describe("storefront UI system", () => {
  ...
  it("renders an image-led tour card with price and booking action", () => {
    const html = renderToStaticMarkup(<TourCard tour={{ slug: "classic-europe", name: "Классик Европ", summary: "Сонгодог аялал", heroImageUrl: "/images/classic-europe.png", durationDays: 11, priceMinor: 3_450_000, currency: "MNT" }} />);
